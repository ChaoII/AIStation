...
--
-- Host: 127.0.0.1    Database: aistation
-- ------------------------------------------------------
...
INSERT INTO `sys_param` VALUES ('网站名称','sys_web_title','aistation',1,1,'32d45f18-098a-40b1-b6a8-263075f194b2','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('网站描述','sys_web_description','aistation 是完全开源的权限管理系统',1,2,'53f0a0d7-502a-4762-9b48-1ad1ae65f558','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('网页图标','sys_web_favicon','https://service.aistation.com/api/v1/static/image/favicon.png',1,3,'69c04e4d-7104-4ded-ad1f-02428e63a4c0','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('网站Logo','sys_web_logo','https://service.aistation.com/api/v1/static/image/logo.png',1,4,'a400e665-0f9e-4873-9f85-4ec85991af72','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('登录背景','sys_login_background','https://service.aistation.com/api/v1/static/image/background.svg',1,5,'3810d178-59fc-45d6-8b05-e36a3042098f','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('版权信息','sys_web_copyright','Copyright © 2025-2026 service.aistation.com 版权所有',1,6,'6d1968e2-caef-4057-a846-85c84b562fec','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('备案信息','sys_keep_record','陕ICP备2025069493号-1',1,7,'31b35782-f4ad-42e7-8f30-682b0720f2da','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('帮助文档','sys_help_doc','https://service.aistation.com',1,8,'a329d554-ba2a-4e63-b690-b79637d571fc','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('隐私政策','sys_web_privacy','https://github.com/aistation/aistation/blob/master/LICENSE',1,9,'b72773c7-9a40-41a9-93ee-07385dc0ad2d','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('用户协议','sys_web_clause','https://github.com/aistation/aistation/blob/master/LICENSE',1,10,'349dc9f0-8aa3-4a8c-b3f8-2422a94997f1','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('源码代码','sys_git_code','https://github.com/aistation/aistation.git',1,11,'3b2fd418-c07c-4a48-b77e-3204379ad657','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('项目版本','sys_web_version','2.0.0',1,12,'3b9e9ab3-1b5f-4d9b-a20f-eed1f9f2463c','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('演示模式启用','demo_enable','false',1,13,'b5ad30cb-5d20-43a7-ba98-52c64262a236','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('演示访问IP白名单','ip_white_list','[\"127.0.0.1\"]',1,14,'b2eb0939-3140-4611-81e2-ec8a955942f4','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('接口白名单','white_api_list_path','[\"/api/v1/system/auth/login\", \"/api/v1/system/auth/token/refresh\", \"/api/v1/system/auth/captcha/get\", \"/api/v1/system/auth/logout\", \"/api/v1/system/config/info\", \"/api/v1/system/user/current/info\", \"/api/v1/system/notice/available\", \"/api/v1/system/auth/auto-login/users\", \"/api/v1/system/auth/auto-login/token\", \"/api/v1/system/auth/auto-login\"]',1,15,'bc38f010-bb80-4d27-ac2c-e7e43c273f90','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL),('访问IP黑名单','ip_black_list','[]',1,16,'4174af47-9685-42d5-aa99-80cbed552aaa','0','初始化数据','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL);
...
INSERT INTO `sys_user` VALUES ('admin','$2b$12$e2IJgS/cvHgJ0H3G7Xa08OXoXnk6N/NX3IZRtubBDElA0VLZhkNOa','超级管理员',NULL,NULL,'0','https://service.aistation.com/api/v1/static/image/avatar.png',1,NULL,NULL,NULL,NULL,NULL,1,1,'7ac2f530-b68e-4dc4-be6b-d6ed2a21c204','0','超级管理员','2026-04-19 22:33:09','2026-04-19 22:33:09',0,NULL,1,NULL,NULL,NULL);
...
--
-- Dumping routines for database 'aistation'
--
--
