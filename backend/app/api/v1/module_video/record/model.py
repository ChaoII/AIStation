...
from sqlalchemy import Boolean, Integer, String, DateTime, Text, BigInteger, ForeignKey
...
class RecordPlanModel(ModelMixin, UserMixin):
    ...
    schedule_json: Mapped[Optional[dict]] = mapped_column(JSONB, nullable=True, comment="时间段配置")
...
class RecordFileModel(MappedBase):
    ...
    duration: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, comment="时长(秒)")
