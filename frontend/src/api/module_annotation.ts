...
export const AnnotationAPI = {
  ...
  getDatasetList(params?: any) {
    return request<ApiResponse<PageResult<any>>>({ url: `${API_PATH}/dataset/list`, method: "get", params })
  },
  ...
  updateDataset(id: number, data: any) {
    return request<ApiResponse<any>>({ url: `${API_PATH}/dataset/update/${id}`, method: "put", data })
  },
  ...
  getTaskList(params?: any) {
    return request<ApiResponse<PageResult<any>>>({ url: `${API_PATH}/task/list`, method: "get", params })
  },
  createTask(data: any) {
  ...
  getAnnotations(taskId: number, imageId: number) {
    return request<ApiResponse<any[]>>({ url: `${API_PATH}/anno/image/${imageId}/annotations`, method: "get", params: { task_id: taskId } })
  },
  saveAnnotations(imageId: number, data: any) {
    return request<ApiResponse<any>>({ url: `${API_PATH}/anno/image/${imageId}/annotations`, method: "put", data })
  },
