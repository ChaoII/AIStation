...
import PanopticSegCanvas from "./PanopticSegCanvas.vue";
import PanopticSegPanel from "./PanopticSegPanel.vue";
import SegmentPreview from "../segmentation/SegmentPreview.vue";
import { useSegmentTool } from "../segmentation/useSegmentTool";

export const panopticSegmentationPlugin: AnnotationTaskPlugin = {
  name: "panoptic_segmentation",
  label: "全景分割",
  color: "primary",
  renderer: PanopticSegCanvas,
  tools: [{ name: "polygon", label: "全景分割", title: "逐点绘制轮廓，双击闭合" }],
  panel: PanopticSegPanel,
